...
<style>
    ...
    * { margin-top: 0 !important; }
    .mb-6:first-child { margin-top: 0 !important; padding-top: 0 !important; }
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Komoditas & Varian</th>
                                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Harga Aktual</th>
                                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Harga Prediksi</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 text-sm">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-gray-600">
                                        ...
                                        <div class="text-xs text-gray-400">{{ \Carbon\Carbon::parse($item->tanggal)->format('d/m/Y') }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        ...
                                        @if($aktual > 0 && $prediksi > 0)
                                            ...
                                            @endif
                                        @else
                                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-50 text-gray-400">Belum ada prediksi</span>
                                        @endif
                                    </td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center text-gray-500 italic">
                                        ...
                                        {{ $tahun }}{{ request('bulan') ? ' / Bulan ' . request('bulan') : '' }}{{ request('minggu') ? ' / Minggu ke-' . request('minggu') : '' }}.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
