...
Route::middleware('auth')->group(function () {
    ...
    // ── USER ROLE ────────────────────────────────────────────────
    // UserController menggunakan logika ForecastingController
    // tetapi me-render ke view 'user_dashboard' (bukan dashboard.index)
    Route::prefix('user')->name('user.')->group(function () {
        Route::get('/dashboard', [UserController::class, 'index'])->name('dashboard');

        // Olah data — menggunakan ForecastingController langsung
        // (render ke dashboard.index, dipakai dari menu olah-data jika ada)
        Route::get('/olah-data', [ForecastingController::class, 'index'])->name('olah-data');

        // Forecast routes (opsional, tetap ada untuk kompatibilitas)
