...
class AdminController extends Controller
{
    ...
    /**
     * Buat HTTP client dengan API key header.
     * Gunakan ini sebagai pengganti Http:: langsung untuk semua call ke Flask.
     */
...
private function processUsersTab(Request $request)
{
    ...
    public function clearModelCache(Request $request, $id)
    {
        try {
            ...
            $response = $this->flaskHttp()->timeout(15)
                ->connectTimeout(5)
    ...
    {
        try {
            $response = $this->flaskHttp()->timeout(30)
                ->connectTimeout(5)
    ...
    private function triggerForceRetrain(int $komoditasId): void
    {
        try {
            ...
            $this->flaskHttp()->timeout(3)->connectTimeout(2)
                ->post("{$this->flaskUrl}/api/forecast/predict-advanced", $payload);
